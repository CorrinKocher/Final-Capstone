...
SELECT AVG(lifeexpectancy) AS 'World Life Expenctancy'
from country
...
SELECT COUNT(name) '1991'
FROM country
WHERE indepyear = '1991';
-- GROUP BY
-- Count the number of countries where each language is spoken, ordered from most countries to least
SELECT language, COUNT(countrycode) CountryCount
...
SELECT AVG(population) AVG, district
FROM city
WHERE countrycode = 'USA'
GROUP BY district
ORDER by district;
