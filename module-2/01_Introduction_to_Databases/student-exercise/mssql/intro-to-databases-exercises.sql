...
SELECT name, region
FROM country
WHERE continent = 'North America' OR continent = 'continent';
...
or continent = 'South America' and region !=  'Caribbean';
