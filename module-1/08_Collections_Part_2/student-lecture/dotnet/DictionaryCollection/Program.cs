...
namespace DictionaryCollection
{
    class Program
    {
        ...
        static void PrintDictionary(Dictionary<string, int> database)
        {
            ...
            {
                Console.WriteLine($"{KeyValuePair} is {KeyValuePair.Value} inches tall");
            }
        }
    }
}
